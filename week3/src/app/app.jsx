export default function App() {
  return (
    <div className="relative">
      <h1 className="sr-only">음악 플레이어</h1>
      <header className="absolute flex flex-row flex-nowrap items-center w-full h-20 bg-[#1D2123] z-[999]">
        <a
          href="/"
          className="inline-block w-[2.125rem] h-[2.125rem] ml-[1.6875rem] mr-[2.1875rem] my-[1.4375rem]"
        >
          <svg
            width={34}
            height={34}
        ...
        <div className="flex flex-row flex-nowrap items-center gap-3 w-full h-full ml-[6rem] mr-[3.875rem]">
          <label htmlFor="inpSearch" className="sr-only">
            검색
          </label>
          <input
            type="search"
            name="inpSearch"
            id="inpSearch"
            className="w-full h-full p-5 text-white placeholder:text-[#464646]"
            placeholder="음악을 검색하세요"
          />
        </div>
      </header>
      <main className="relative flex flex-row flex-nowrap items-start pt-[6.4375rem] h-full">
        <aside className="sticky top-0 left-0 flex flex-col flex-nowrap gap-[1.25rem] w-[6rem] px-[1.375rem]">
          <ul className="flex flex-col flex-nowrap items-center gap-[1.9375rem] px-[.375rem] py-[1.25rem] rounded-full bg-[#1A1E1F]">
            <li>
              <a
                href="/"
          ...
          <ul className="flex flex-col flex-nowrap items-center gap-[1.9375rem] px-[.375rem] py-[1.25rem] rounded-full bg-[#1A1E1F]">
            <li>
              <a href="/" className="flex justify-center items-center size-10">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={22}
                  height={22}
        ...
        <div className="w-[calc(100%-(6rem))] pr-[3.6875rem]  h-full">
          <section className="flex flex-row flex-nowrap gap-[1.375rem] w-full h-full">
            <div className="flex flex-row flex-nowrap justify-center items-center shrink-1 w-full h-[26.25rem] mr-auto rounded-[1.25rem] bg-[#609EAF]">
              <figure>
                <a href="/">
                  <picture className="object-cover">
                    <img
                      src="./public/images/img-banner01.png"
                      alt="Currated playlist R & B Hits All mine, Lie again, Petty call me everyday, Out of time, No love, Bad habit, and so much more"
                    />
                  </picture>
                </a>
                <figcaption className="sr-only">
                  Currated playlist R &amp; B Hits All mine, Lie again, Petty
                  call me everyday, Out of time, No love, Bad habit, and so much
                  more
                </figcaption>
              </figure>
            </div>
            <div className="shrink-0 w-[26.0625rem]">
              <h2 className="text-white text-[1.5rem] font-medium">
                Top Charts
              </h2>
              <ul className="flex flex-col flex-nowrap gap-3 mt-[.875rem]">
                <li className="flex flex-row p-[1.0625rem] bg-[#1A1E1F] rounded-[1.25rem]">
                  <figure className="flex flex-row items-center gap-[.875rem] mr-auto">
                    <a href="/" className="size-[3.9375rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music01.png"
                          alt="Golden age of 80s"
                        />
                      </picture>
                    </a>
                    <figcaption>
                      ...
                      <p className="text-[#3f3e3e]">Sean swadder</p>
                      <p className="text-white">2:34:45</p>
                    </figcaption>
                  </figure>
                  <button
                    type="button"
                    className="flex flex-row flex-nowrap justify-center items-center self-end size-[2.3125rem] border border-[#3f3e3e] rounded-full hover:border-white"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={18}
          ...
          <section className="mt-8">
            ...
            <ul className="overflow-x-auto flex flex-row flex-nowrap gap-3 mt-4 text-white text-[1rem]/4">
              <li>
                <a
                  href="/"
                  className="flex flex-row flex-nowrap justify-center items-center px-5 py-2 border border-[#3f3e3e] rounded-full bg-[#FACD66] text-black font-bold"
                >
                  ALL
                </a>
              </li>
              <li>
                <a
                  href="/"
                  className="flex flex-row flex-nowrap justify-center items-center px-5 py-2 border border-[#3f3e3e] rounded-full"
                >
                  Relax
                </a>
              </li>
            ...
            <div className="overflow-hidden mt-3">
              <ul className="flex flex-row flex-nowrap gap-x-[1.875rem]">
                <li>
                  <figure className="flex flex-col flex-wrap gap-y-1">
                    <a href="/" className="size-[9.5625rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music02.png"
                          alt="Life in a bubble"
                        />
                      </picture>
                    </a>
                    <figcaption>
                      ...
                      <p className="text-[#3f3e3e]">The van</p>
                    </figcaption>
                  </figure>
                </li>
                <li>
                  <figure className="flex flex-col flex-wrap gap-y-1">
                    <a href="/" className="size-[9.5625rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music03.png"
                          alt="Life in a bubble"
                        />
                      </picture>
                    </a>
                ...
                <li>
                  <figure className="flex flex-col flex-wrap gap-y-1">
                    <a href="/" className="size-[9.5625rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music04.png"
                          alt="Life in a bubble"
                        />
                      </picture>
                    </a>
                ...
                <li>
                  <figure className="flex flex-col flex-wrap gap-y-1">
                    <a href="/" className="size-[9.5625rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music06.png"
                          alt="Life in a bubble"
                        />
                      </picture>
                    </a>
                ...
                <li>
                  <figure className="flex flex-col flex-wrap gap-y-1">
                    <a href="/" className="size-[9.5625rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music05.png"
                          alt="Life in a bubble"
                        />
                      </picture>
                    </a>
                ...
                <li>
                  <figure className="flex flex-col flex-wrap gap-y-1">
                    <a href="/" className="size-[9.5625rem] aspect-square">
                      <picture>
                        <img
                          src="./public/images/img-music07.png"
                          alt="Life in a bubble"
                        />
                      </picture>
                    </a>
      ...
      <footer className="mx-20 mt-20 mb-30">
        <address className="text-[#6b6868] text-right">
          <span>music player s</span>
          <span aria-hidden="true">|</span>
          <span>ceo. Sean swadde</span>
          <span>seoul</span>
          <span>
            business number
            <span aria-hidden="true">:</span> 123-46-56789
          </span>
          <span aria-hidden="true">|</span>
          <span>
            문의처
            <a href="mailto:contact@naver.com?subject=문의사항">
              contact@naver.com
            </a>
          </span>
        </address>
      </footer>
      <div className="fixed flex flex-row flex-nowrap items-center gap-10 bottom-0 pl-[6rem] pr-[3.6875rem] py-3 w-full bg-black/50 backdrop-blur-md shadow-lg p-6">
        <div className="flex flex-row flex-nowrap shrink-0">
          <figure className="flex flex-row flex-wrap items-center gap-x-3">
            <a href="/" className="size-[2.5rem] aspect-square">
              <picture>
                <img
                  src="./public/images/img-music01.png"
                  alt="Life in a bubble"
            ...
            <figcaption className="text-white text-[.8125rem]">
              <a href="/">Life in a bubble</a>
              <p>The van</p>
            </figcaption>
          </figure>
        </div>
        ...
        <div className="flex-1">
          <div className="p-4 flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <span id="currentTime" className="text-xs text-white/80">
                0:00
              </span>
